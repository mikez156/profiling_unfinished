	...
	<div class="container">
        ...
        <table class="pinfo">
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: center;"><input class="btn btn-success" type="submit" id="svmembtn" value="Save"><input class="btn btn-primary" type="submit" id="newmembtn" value="New" style="margin-left: 100px;"></td>
            </tr>
